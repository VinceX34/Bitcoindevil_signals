...
export async function GET(req: Request) {
  ...
  try {
    ...
    console.error('[Forwarded AI GET] DB-fout:', e);
    return NextResponse.json(
      { success: false, error: 'Failed to fetch forwarded signals for AI group', details: e.message },
      { status: 500 },
    );
  }
} 